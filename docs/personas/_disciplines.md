...
- Write decisions, findings, and handoffs to issues (with the correct record type header) rather
...
Write for the reader who is short on time, not the writer who wants to be thorough.
